...
_OTHERS = controller/GameController.cpp model/game/data/Level.cpp view/menu/MenuView.cpp model/game/data/entity/Player.cpp view/game/data/EntityRenderer.cpp
